...
export default function PremiumOffer() {
  ...
  return (
    <div>
        ...
        <h1 className="flex justify-center text-xl font-bold pt-6">Votre site web vitrine premium</h1>
...
<ul>
    ...
    <li className="flex"><Check/>Site web entièrement personnalisable et moderne</li>
