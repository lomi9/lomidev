...
const HeroVideo = () => {
const lightVideoSource = "/hero_videos/hero_video.mp4";
const darkVideoSource = "/hero_videos/night_sky.mp4";
...
return (
    ...
    <video key={videoSource} autoPlay loop muted playsInline className="heroVideo w-full h-full object-cover">
        <source src={`${videoSource}`} type="video/mp4" media="all and (min-width: 1024px)" />
        <source src={`${videoSource}_720p.mp4`} type="video/mp4" media="all and (min-width: 600px)" />
        <source src={`${videoSource}_480p.mp4`} type="video/mp4" media="all and (max-width: 599px)" />
