...
const CtaButton = ( {buttonText} ) => {
  return (
        <button className="relative min-w-[140px] inline-flex h-auto overflow-hidden rounded-full p-[1px] focus:outline-none focus:ring-2 focus:ring-teal-300 focus:ring-offset-2 focus:ring-offset-teal-100">
          ...
          <span className="flex gap-4 h-full w-full cursor-pointer items-center justify-center rounded-full bg-btnbackground hover:bg-background/30 hover:text-btnactivetext px-2 py-1 text-sm font-medium text-foreground backdrop-blur-3xl">
